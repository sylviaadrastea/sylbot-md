...
}, 1440 * 9000) // Save every minute
if (opts['server']) require('./server')(global.conn, PORT)

conn.connectOptions.maxQueryResponseTime = 1440_000
if (opts['test']) {
  conn.user = {
...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai, @user!\nSelamat datang di grup *@subject* semoga betah\nSilahkan ketik *.menu* jika ingin berkomunikasi denganku'
  conn.bye = 'Selamat tinggal @user! semoga tenang'
